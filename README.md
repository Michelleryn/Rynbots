...
[![Codefactor](https://www.codefactor.io/repository/github/Michelleryn/imagetosticker/badge)](https://www.codefactor.io/repository/github/Michelleryn/imagetosticker)
<details>
 <summary>🥟 Help me!</summary>

 [Saweria](https://Instagram.com/rhemisyeli)
...
```bash
> git clone https://github.com/Michelleryn/imageToSticker.git
> cd imageToSticker
```
